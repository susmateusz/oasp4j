...
INSERT INTO StaffMember (id, modificationCounter, role, login, password, firstname, lastname) VALUES (0, 0, 3, 'chief', 'chief', 'Charly', 'Chief');
-- INSERT INTO StaffMember (id, modificationCounter, role, login, password, firstname, lastname) VALUES (1, 0, 0, 'cook', 'cook', 'Carl', 'Cook');
...
INSERT INTO StaffMember (id, modificationCounter, role, login, password, firstname, lastname) VALUES (4, 0, 4, 'manager','manager', 'Piotr', 'Poprawski');
